        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <CardContent>
                 ...
                 <div className="flex items-center justify-between">
                   <span className="text-sm text-gray-600 dark:text-gray-400">การตรวจจับทั้งหมด</span>
                   <Badge variant="outline" className="bg-gray-50 dark:bg-gray-800">
                     {totalDetectionCount} รายการ
                   </Badge>
                 </div>
                 <div className="flex items-center justify-between">
                   <span className="text-sm text-gray-600 dark:text-gray-400">แสดงในหน้านี้</span>
                 ...
                 <div className="flex items-center justify-between">
                   <span className="text-sm text-gray-600 dark:text-gray-400">24 ชั่วโมงที่ผ่านมา</span>
                   <Badge variant="outline" className="bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800">
                     {last24HoursCount} ครั้ง
                   </Badge>
                 </div>
               </div>
          </CardContent>
